...
const FilterRegion = ({ setSelectFilter }) => {
  ...
  return (
    <div
      className={`relative w-[184px] h-8 lg:h-10 m:h-9 shadow-[0_0_8px_0_rgba(0,0,0,0.2)] rounded px-4 py-2 text-xs mb-5 cursor-pointer
    ...
    >
      ...
      {display && (
        <div
          className={`absolute w-full top-full left-0 mt-2 shadow-[0_0_8px_0_rgba(0,0,0,0.2)] rounded z-10 px-4 py-2 flex flex-col gap-1 text-sm
          ${isDark ? "bg-[var(--dark-blue-elements)] text-white" : "bg-white text-black"}`}
